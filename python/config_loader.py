...
def load_config(config_path: str | Path | None = None) -> dict[str, Any]:
    ...
    cfg: dict[str, Any] = {
        ...
        "omega_api_base": get("omega", "api_base", "https://omega-auto-parts.kz/api/v1").rstrip("/"),
        "omega_timeout": float(get("omega", "timeout", "5") or 5),
        "omega_enrich_articles": _as_bool(get("omega", "enrich_articles", "false"), False),
        "omega_enrich_limit": int(get("omega", "enrich_limit", "3") or 3),
        "omega_test_number": get("omega", "test_number", "120281"),
        ...
        "ntin_page_size": int(get("ntin", "page_size", "10") or 10),
        "ntin_max_queries": int(get("ntin", "max_queries", "12") or 12),
        "ntin_web_search": _as_bool(get("ntin", "web_search", "false"), False),
        "ntin_timeout": float(get("ntin", "ntin_timeout", "3.5") or 3.5),
