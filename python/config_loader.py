...
def load_config(config_path: str | Path | None = None) -> dict[str, Any]:
    ...
    cfg: dict[str, Any] = {
        ...
        "max_candidates": int(get("search", "max_candidates", "12") or 12),
        "http_timeout": float(get("search", "http_timeout", "25") or 25),
        ...
        "selection_mode": get("ui", "selection_mode", "auto_single"),
    }
